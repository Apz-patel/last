...
class HomePageViewController: UIViewController {
    ...
    @IBOutlet weak var asSeenOnCollectionView: UICollectionView!
    ...
    private func registerCell(){
        ...
        asSeenOnCollectionView.register(UINib(nibName: "KaranJoharCollectionViewCell", bundle: nil), forCellWithReuseIdentifier: "karan")
...
extension HomePageViewController: UICollectionViewDelegate, UICollectionViewDataSource{
    ...
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        ...
        }else if collectionView == asSeenOnCollectionView{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        if collectionView == firstCollection {
            ...
            let cell = asSeenOnCollectionView.dequeueReusableCell(withReuseIdentifier: "karan", for: indexPath) as! AsSeenOnCollectionViewCell
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if collectionView == asSeenOnCollectionView {
            if selectedIndex == 0 {
                let  alayaViewController = storyboard?.instantiateViewController(withIdentifier: "AlayaViewController") as! AlayaViewController
                self.navigationController?.pushViewController(alayaViewController, animated: true)
            } else if selectedIndex == 1 {
                let  kiaraSpacksViewController = storyboard?.instantiateViewController(withIdentifier: "KiaraSpacksViewController") as! KiaraSpacksViewController
                self.navigationController?.pushViewController(kiaraSpacksViewController, animated: true)
            } else if selectedIndex == 2 {
                let  rheaViewController = storyboard?.instantiateViewController(withIdentifier: "RheaViewController") as! RheaViewController
                self.navigationController?.pushViewController(rheaViewController, animated: true)
            } else if selectedIndex == 3 {
                let  karanSpacksViewController = storyboard?.instantiateViewController(withIdentifier: "KaranSpacksViewController") as! KaranSpacksViewController
                self.navigationController?.pushViewController(karanSpacksViewController, animated: true)
            }
        }
    }
}
